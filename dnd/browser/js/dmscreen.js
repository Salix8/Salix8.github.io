...
class Panel {
	...
	doPopulate_Adventures (adventure, chapter, skipSetTab, title) { // FIXME skipSetTab is never used
		...
		if (!Object.keys(this.availAdventures || {}).length) {
			this.set$Tab(
				ix,
				PANEL_TYP_ADVENTURES,
				meta,
				$(`<div class="panel-content-wrapper-inner"><div class="ve-muted p-3">Adventure content has been removed from this local build.</div></div>`),
...
class AdventureOrBookLoader {
	...
	_getJsonPath (bookOrAdventure) {
		switch (this._type) {
			case "adventure": throw new Error("Adventure content has been removed from this local build.");

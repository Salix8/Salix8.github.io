					...
					switch (k) {
						...
						case "feat":
							return isListMode
								...
								: v.map(x => x.split("|")[0].toTitleCase()).joinConjunct(", ", " or ");
						case "item":
							return isListMode ? v.map(x => x.toTitleCase()).join("/") : v.joinConjunct(", ", " or ");
						case "otherSummary":
						...
						case "spellcasting":
						case "spellcasting2020": return isListMode ? "Spellcasting" : "The ability to cast at least one spell";
